"""Native cognis-connect emit for fhirlint — forward findings to any platform.

Maps fhirlint's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    fhirlint ... --format json | fhirlint-emit --to stix
    fhirlint-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""

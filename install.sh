#!/usr/bin/env sh
# Universal installer for fhirlint. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/fhirlint.git"
echo "Installing fhirlint ..."
